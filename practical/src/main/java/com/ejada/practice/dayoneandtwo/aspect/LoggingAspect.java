package com.ejada.practice.dayoneandtwo.aspect;
 ...
 * intercepts calls to every method under {@code com.ejada.practice.dayoneandtwo.service}
...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* com.ejada.practice.dayoneandtwo.service..*(..))")
